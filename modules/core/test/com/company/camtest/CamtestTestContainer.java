...
public class CamtestTestContainer extends TestContainer {

    public CamtestTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/camtest/app.properties",
    ...
    public static class Common extends CamtestTestContainer {

        public static final CamtestTestContainer.Common INSTANCE = new CamtestTestContainer.Common();
